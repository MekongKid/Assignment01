...
let current-month; // let current_Month;
let summer_month; // let summer_Month;
let MyLibrary-function // let MyLibrary_function
...
// STEP 10. Use the unary typeof operator on various literals to return the following types within the console window: string, 
...
// STEP 21. Using a set of Comparison and Logical operators, write an application that evaluates to true and displays the result 
